...
# Other settings: Transformer encoder layers (num_encoder_layer, 6), decoder layers (num_decoder_layer, 6), model_size (hidden_size and embed_size, 512, filter_size 2048)
